            ...
            <div class="p-8 sm:p-12">
                    ...
                    <div class="flex justify-center mb-8">
                        <div class="flex items-center space-x-4">
                            <div class="flex items-center">
                                <span
                                    class="w-10 h-10 flex items-center justify-center rounded-full font-bold transition-all duration-300 shadow-sm"
                                    :class="step >= 1 ? 'bg-blue-600 text-white ring-4 ring-blue-100' : 'bg-gray-200 text-gray-500'">1</span>
                                <span class="ml-3 font-medium text-sm hidden sm:block"
                                    :class="step >= 1 ? 'text-blue-600' : 'text-gray-500'">Akun</span>
                            </div>
                            <div class="h-1 w-16 bg-gray-200 rounded-full" :class="step >= 2 ? 'bg-blue-600' : ''">
                            </div>
                            <div class="flex items-center">
                                <span
                                    class="w-10 h-10 flex items-center justify-center rounded-full font-bold transition-all duration-300 shadow-sm"
                                    :class="step >= 2 ? 'bg-blue-600 text-white ring-4 ring-blue-100' : 'bg-gray-200 text-gray-500'">2</span>
                                <span class="ml-3 font-medium text-sm hidden sm:block"
                                    :class="step >= 2 ? 'text-blue-600' : 'text-gray-500'">Data Anak</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" name="name" required
                                    ...
                                    placeholder="Masukan nama lengkap anak" value="{{ old('name') }}">
                            </div>
                            <div class="space-y-2">
                            ...
                            <div class="col-span-1 md:col-span-2 space-y-2">
                                ...
                                <input type="text" name="mother_name" required
                                    class="w-full px-4 py-3 rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition border bg-gray-50 focus:bg-white"
                                    placeholder="Nama lengkap ibu kandung" value="{{ old('mother_name') }}">
                            </div>
                        </div>
                        <div class="mt-8 flex justify-end">
                            <button type="button" @click="step = 2"
                                class="px-8 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transform hover:scale-105 transition shadow-lg flex items-center">
                                Lanjut
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                            ...
                            <div class="col-span-1 md:col-span-2 space-y-2">
                                ...
                                <textarea name="address" rows="3" required
                                    class="w-full px-4 py-3 rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition border bg-gray-50 focus:bg-white"
                                    placeholder="Jalan, RT/RW, Dusun...">{{ old('address') }}</textarea>
                            </div>
                        </div>
                        <div class="mt-8 flex justify-between items-center">
                            <button type="button" @click="step = 1"
                                class="px-6 py-3 bg-gray-100 text-gray-700 rounded-xl font-bold hover:bg-gray-200 transition flex items-center">
                            ...
                            <button type="submit"
                                class="px-8 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transform hover:scale-105 transition shadow-lg">Daftar
                                Sekarang</button>
                        </div>
                    </div>
                </form>
                ...
                <div class="mt-8 text-center border-t pt-6">
                    <p class="text-sm text-gray-600">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="font-medium text-blue-600 hover:text-blue-500">Masuk
                            disini</a>
                    </p>
                </div>
            </div>
