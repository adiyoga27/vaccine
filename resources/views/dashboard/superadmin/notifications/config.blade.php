...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6" x-data="wahaConfig">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:col-span-1">
        ...
        <!-- Offline Server Info -->
        <div x-show="!loading && status === 'OFFLINE'" class="text-center py-6">
            ...
            <h4 class="font-bold text-gray-900">Server Offline</h4>
            <p class="text-xs text-gray-600 mb-4 px-2">Gagal menghubungkan ke server WAHA. Silakan cek koneksi server atau hubungi pengembang.</p>
            <button @click="fetchStatus" class="inline-flex items-center px-3 py-1 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-xs font-medium transition">
                Coba Lagi
            </button>
        </div>
