...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        ...
        <div class="flex gap-2">
            <a href="{{ route('superadmin.reports.immunization.export', request()->all()) }}" target="_blank"
    ...
    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6">
        <form action="{{ route('superadmin.reports.immunization') }}" method="GET" class="flex flex-wrap gap-4 items-end">
            <div>
            ...
            <div>
                <label for="office_id" class="block text-xs font-medium text-gray-700 mb-1">Pilih Kantor</label>
                <select name="office_id" id="office_id" class="border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500">
