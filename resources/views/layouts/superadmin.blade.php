        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="p-6 h-full overflow-y-auto">
                ...
                <nav class="space-y-1">
                    ...
                    <div class="pt-4 pb-2">
                        <p class="px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Monitoring & Pengaturan</p>
                    </div>
                    <a href="{{ route('admin.certificate-settings') }}"
                        class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.certificate-settings') ? 'bg-slate-800 text-purple-400' : 'text-gray-400 hover:bg-slate-800 hover:text-white' }} transition">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.history') }}"
                        class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.history') ? 'bg-slate-800 text-purple-400' : 'text-gray-400 hover:bg-slate-800 hover:text-white' }} transition">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.kipi') }}"
                        class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.kipi') ? 'bg-slate-800 text-purple-400' : 'text-gray-400 hover:bg-slate-800 hover:text-white' }} transition">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.logs') }}"
                        class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.logs') ? 'bg-slate-800 text-purple-400' : 'text-gray-400 hover:bg-slate-800 hover:text-white' }} transition">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
