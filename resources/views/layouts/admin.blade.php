        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-30 w-64 bg-slate-900 text-white transition-transform duration-300 md:translate-x-0 md:static md:inset-auto md:h-screen md:sticky md:top-0 transform -translate-x-full">
            <div class="p-6 h-full overflow-y-auto">
                ...
                <nav class="space-y-1">
                    ...
                    <a href="{{ route('admin.certificate-settings') }}" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.certificate-settings') ? 'bg-slate-800 text-blue-400' : 'text-gray-400 hover:bg-slate-800 hover:text-white' }} transition">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path></svg>
                        Sertifikat
                    </a>
                    <a href="{{ route('admin.admins') }}" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.admins') ? 'bg-slate-800 text-blue-400' : 'text-gray-400 hover:bg-slate-800 hover:text-white' }} transition">
                    ...
                    <a href="{{ route('admin.notifications.config') }}" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.notifications.config') ? 'bg-slate-800 text-blue-400' : 'text-gray-400 hover:bg-slate-800 hover:text-white' }} transition">
                    ...
                    <a href="{{ route('admin.notifications.templates') }}" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.notifications.templates') ? 'bg-slate-800 text-blue-400' : 'text-gray-400 hover:bg-slate-800 hover:text-white' }} transition">
                    ...
                    <a href="{{ route('admin.notifications.history') }}" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.notifications.history') ? 'bg-slate-800 text-blue-400' : 'text-gray-400 hover:bg-slate-800 hover:text-white' }} transition">
