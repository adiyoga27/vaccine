...
class SuperadminImmunizationExport implements FromView
{
    protected $request;
    ...
    public function view(): View
    {
        ...
        $office_id = $this->request->input('office_id');
        ...
        return view('dashboard.superadmin.reports.immunization-export', [
            'villages' => $villages,
            'vaccines' => $vaccines,
            'data' => $data,
            'month' => $month,
